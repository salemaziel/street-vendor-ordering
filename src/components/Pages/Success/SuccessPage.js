...
function SuccessPage(props) {
  return (
    <>
      <section className="flex flex-wrap items-center h-auto max-w-4xl py-32 mx-auto lg:h-screen lg:my-0">
        {/*Main Col*/}
        <div
          id="profile"
        ...
        >
          <div className="p-4 text-center md:p-12 lg:text-left">
            ...
            <div className="block w-48 h-48 mx-auto -mt-16 bg-center bg-cover rounded-full shadow-xl lg:hidden bgProfilePic" />
            ...
            <p className="pt-8 text-sm">{props.optionalBio}</p>
            <div className="p-0 text-center">
              <span className="text-4xl font-bold text-center text-green-700">
                Order Successful!
              </span>
              <div className="py-6 mx-auto my-8">
                <Link to="/" className="w-8 h-4 p-6 text-xl font-bold text-white bg-green-700 rounded-lg hover:bg-green-500">
                  Back to Ordering
                </Link>
              </div>
