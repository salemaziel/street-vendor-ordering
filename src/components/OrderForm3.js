        ...
        <div className="flex flex-col justify-center mb-4 text-center">
          ...
          <label htmlFor="text" className="text-sm leading-7 text-gray-600">
            ...
            <input
              ...
              id="tamalecost"
              name="tamaleCost"
              {...register("tamaleCost", { setValueAs: watchAllFields.tamales * 2 })}
              
              className="w-full px-3 py-1 text-base leading-8 text-gray-700 transition-colors duration-200 ease-in-out bg-white border border-gray-300 rounded outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
              ref={register({ })}
              value={[watchAllFields.tamales * 2]}
            />
          </label>
          <div className="flex flex-row justify-evenly">
          <div className="mx-auto text-xl text-center text-black">
            
            {watchAllFields.tamales && (<input type="number" className="text-center text-black border-0 border-white border-none" value={...register(`${["watchAllFields.tamales * 2"]}`) } />) }
          </div>
          <div className="mx-auto text-xl text-center text-black">
            {watchAllFields.tortas  (<input type="number" className="text-center text-black border-0 border-white border-none" value={...register(`${["watchAllFields.tortas * 5"]}`) } />) }
          </div>
          </div>
        </div>
